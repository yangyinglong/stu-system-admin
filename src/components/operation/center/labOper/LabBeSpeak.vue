		...
		<div class="content">
			...
			<el-form label-width="70px" :model="labBeSpeakFrom">
				...
				<el-form-item style="margin-left: -40px">
					<el-button type="primary" @click="onSubmit" style="width: 100px">预约</el-button>
...
export default {
	...
	created(){
		...
		this.labBeSpeakFrom.labBeSpeakName = sessionStorage.getItem('userName')
	...
	methods: {
		...
		onSubmit() {
			...
			console.log(this.labBeSpeakFrom)
			this.$http.AddOrder(this.labBeSpeakFrom).then((result) => {
				if (result.c == 200) {
					this.$message({
						message: result.r,
						type: 'success'
